		...
		<div className="floating-contact-panel">
			...
			>
				<div className="contact-btn-icon">
					...
					<img src="/images/hyderabad-location.webp" alt="Hyderabad" width="20" height="20" className="location-image" />
				</div>
				<div className="contact-btn-content">
			...
			>
				<div className="contact-btn-icon">
					...
					<img src="/images/khammam-location.jpg" alt="Khammam" width="20" height="20" className="location-image" />
				</div>
				<div className="contact-btn-content">
